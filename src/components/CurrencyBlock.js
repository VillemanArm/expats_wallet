...
class CurrencyBlock extends React.Component {
    ...
    inputValidate = () => {
        ...
        if (!this.numbers.test(amount) && dotsMatch) {
            if (
                dotsMatch.length === 1 &&
                amount.value.length - amount.value.indexOf(".") > 3
            ) {
                amount.value = amount.value.slice(
                    0,
                    amount.value.indexOf(".") + 3
                );
            }
        }
    };
        ...
        return (
            ...
            >
                ...
                >
                    <div className="currency-block__inputs-wrapper">
                        ...
                        <div>
                            <input
                                ...
                                className={
                                    this.currency.error
                                        ? "currency-block__amount error"
                                        : "currency-block__amount"
                                }
                    ...
                    {this.currency.error && (
                        <div className="currency-block__error error">
                            {this.currency.error}
                        </div>
                    )}
                </div>
